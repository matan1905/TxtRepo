...
- Support for file deletion (full file or content only) and content injection at specific lines
...
For multiple files, repeat the format. To delete a file or its content, use the following syntax:

```
# File /path/to/delete::delete:full
# EndFile /path/to/delete

# File /path/to/clear::delete:content
# EndFile /path/to/clear
```
